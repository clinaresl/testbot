...
# Last update <martes, 23 septiembre 2014 07:38:38 Carlos Linares Lopez (clinares)>
# -----------------------------------------------------------------------------
#
# $Id::                                                                      $
# $Date::                                                                    $
...
class BotTestArgParser ():
    ...
    def __init__ (self):
        ...
        self._optional.add_argument ('-o', '--output',
                                     default='$index',
                                     help="prefix of the output files generated by the solver. Placeholders can be used. For a description of the available placeholders type '--show-placeholders'. By default '$file'")
...
# directory. This funciton is a helper of the parser implemented in BotTestCase
# -----------------------------------------------------------------------------
class ShowPlaceHoldersParser (argparse.Action):
    """
    shows a comprehensive list of the available place holders for making
    substitutions in the text files as they are copied to the results/
    directory. This funciton is a helper of the parser implemented in
    BotTestCase
    """

...
# Last update <sábado, 14 diciembre 2013 00:01:33 Carlos Linares Lopez (clinares)>
# -----------------------------------------------------------------------------
#
# $Id::                                                                      $
# $Date::                                                                    $
...
class ShowTests (argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        if not namespace.tests:
            ...
            print "        make sure to invoke --parse-tests *after* --test"
            print
            sys.exit (0)
...
class ShowDatabaseSpec (argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        if not namespace.db:
            ...
            print "        make sure to invoke --parse-db *after* --db"
            print
            sys.exit (0)
